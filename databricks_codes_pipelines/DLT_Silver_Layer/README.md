...
This folder defines all source code for the 'DLT_Bookings_Silver' pipeline:
...
* Take a look at the sample under "sample_users_dlt_bookings_silver.py" to get familiar with the syntax.
